...
updater.addon = "blender_daily_tips"
...
def update_settings_ui(self, context, layout=False):
...
def register(bl_info):
	...
	updater.repo = "blender-daily-tips"

	#updater.addon = # define at top of module, must be done first

	# Website for manual addon download, optional 
	updater.website = "https://github.com/TheDuckCow/blender-daily-tips/"
	...
	# only wanting to get notification of update_settings_ui
